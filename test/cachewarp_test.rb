...
describe CacheWarp do
  describe "when a site is checked for Akamai caching" do
  ...
  describe "when a site is checked for Akamai caching without using fetch" do
    it "should be cached with akamai cache headers" do
      uri = 'http://www.akamai.com/'
      request = CacheWarp.new(uri)
      request.is_cached?.must_equal true
  ...
  describe "when an invalid site is checked for Akamai caching" do
  ...
  describe "when a site is checked for Akamai caching using commandline" do
    it "should be cached with akamai cache headers" do
      uri = 'http://www.akamai.com/'
